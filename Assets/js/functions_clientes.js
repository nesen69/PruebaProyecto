...
document.addEventListener('DOMContentLoaded', function(){ //Agregamos los eventos
	...
	if(document.querySelector("#formCliente")){
        ...
        formCliente.onsubmit = function(e) {
            ...
            if(strIdentificacion == '' || strApellido == '' || strNombre == '' || strEmail == '' || intTelefono == '' || strDireccion == '')
...
function fntEditInfo(element, idpersona){
    ...
    document.querySelector('#titleModal').innerHTML ="Actualizar cliente";//Cambio de apariencia del modal
...
function fntDelInfo(idpersona){
    ...
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Clientes/delCliente'; //Controlador y metodo
