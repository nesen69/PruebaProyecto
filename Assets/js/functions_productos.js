...
window.addEventListener('load', function(){
    ...
    if(document.querySelector("#formProductos")){
        ...
        formProductos.onsubmit = function(e) {
            ...
            let strDescripcionCorta = document.querySelector('#txtDescripcionCorta').value;
                    ...
                    if(objData.status)
                    {
                        ...
                        if(rowTable == ""){
                           ...
                           htmlStatus = intStatus == 1 ? 
                            ...
                            rowTable.cells[2].textContent = strFecha;
                            rowTable.cells[3].textContent = intCodigo;
                            rowTable.cells[4].textContent = intStock;
                            rowTable.cells[5].textContent = smoney+strPrecio;
...
/*-------------EL SIGUIENTE CODIGO TRABAJA CON EL CAMPO DESCRIPCION-------------*/
    ...
    request.onreadystatechange = function(){
        ...
        if(request.status == 200){
            ...
            if(objData.status)
            {
                ...
                itemRemove.parentNode.removeChild(itemRemove);//Remover el elemento hijo
            }else{
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#celDescripcionCorta").innerHTML = objProducto.descripcion_corta;
...
function fntEditInfo(element,idProducto){//junto con this en el boton editar del controlador se usa este "eleent" y tambien la siguiente linea
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtFecha").value = objProducto.fecha_sorteo;
                document.querySelector("#txtDescripcion").value = objProducto.descripcion;
                document.querySelector("#txtDescripcionCorta").value = objProducto.descripcion_corta;
