...
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(document.querySelector("#formUsuario")){// Crear y actualizar usuarios
                ...
                if(request.readyState == 4 && request.status == 200){
                    ...
                    if(objData.status)
                    {
                        if(rowTable == ""){
                            ...
                            rowTable.cells[3].textContent = strIdentificacion;
        ...
        formPerfil.onsubmit = function(e) {
            ...
            {   
                ...
                if(strPassword.length < 3 ){
                    swal("Atención", "La contraseña debe tener un mínimo de 3 caracteres." , "info");
                    return false;
                }
            }
    ...
    if(document.querySelector('#listRolid')){
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                ...
                /*document.querySelector('#listRolid').value = 1;//Primer elemento del SELECT*/
...
function openModal(){
    ...
    document.querySelector('#btnText').innerHTML ="Guardar"; //Cambiamos el texto
    document.querySelector('#titleModal').innerHTML ="Nuevo Usuario"; //Cambiamos el titulo
    document.querySelector("#formUsuario").reset(); //Reseteamos el formulario "Limpiar todos los campos"
