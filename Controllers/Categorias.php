<?php 
	...
	class Categorias extends Controllers{
		public function __construct(){
			...
			getPermisos(MCATEGORIAS);// Corresponde al numero en la BD/Tabla Modulo->idmodulo
		}
		...
		public function Categorias(){
			...
			$data['page_title'] = "CATEGORIAS - <small>".NOMBRE_EMPRESA."</small>";
		...
		public function setCategoria(){
			...
			if($_POST){
				if(empty($_POST['txtNombre']) || empty($_POST['txtDescripcion']) || empty($_POST['listStatus']) )
				{
					...
					if($intIdcategoria == 0){
						//Crear
						$request = $this->model->insertCategoria($strCategoria, $strDescripcion,$imgPortada,$ruta,$intStatus);
						$option = 1;
					}else{
						//Actualizar
						if($nombre_foto == ''){
						...
						$request = $this->model->updateCategoria($intIdcategoria,$strCategoria, $strDescripcion,$imgPortada,$ruta,$intStatus);
						$option = 2;
					}
					if($request > 0 )
					{
