...
<main class="app-content">
              ...
              if(count($data['lastOrders']) > 0){ 
                foreach ($data['lastOrders'] as $pedido) {
                  ...
                  <tr>
                    ...
                    <th class="stext-113 cl3"><a href=" <?= base_url() ?>/pedidos/orden/<?= $pedido['idpedido'] ?> " target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></th>
                  </tr>
                <?php } 
              } ?>
            </tbody>
    ...
    <div class="col-md-6">
      <div class="tile">
        <div class="container-title">
          <h3 class="tile-title stext-113 cl2">Tipo de pagos por mes</h3>
          <div class="dflex">
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="container-title">
          <h3 class="tile-title stext-113 cl2">Ventas por año</h3>
          <div class="dflex">
...
<script>
  ...
  Highcharts.chart('pagosMesAnio', {
    ...
    title: {
      text: 'Ventas por tipo de pago, <?= $data['pagoMes']['mes'].' '.$data['pagoMes']['anio'] ?> '
    },
    tooltip: {
    ...
    series: [{
      ...
      <?php foreach ($data['pagoMes']['tipospago'] as $pagos){
  ...
  Highcharts.chart('graficaAnio', {
    ...
    tooltip: {
      pointFormat: '<b>{point.y:.1f} Dolares</b>'
    },
    series: [{
      name: 'Population',
      data: [
