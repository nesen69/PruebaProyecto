    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <h3 class="login-head ltext-108 cl5"><i class="fa fa-lg fa-fw fa-user"></i>Iniciar sesión</h3>
          ...
          <div class="form-group">
            ...
            <div class="utility">
              <p class="semibold-text mb-2"><a href="<?= base_url(); ?>/registro">¿No tienes cuenta? (Registrate)</a></p>
            </div>
          </div>
        ...
        <form id="formResetPass" name="formResetPass" class="forget-form" action="">
          ...
          <h3 class="login-head ltext-108 cl5"><i class="fa fa-lg fa-fw fa-lock"></i>¿Olvidaste tu contraseña?</h3>
          <div class="form-group">
            <label class="control-label">EMAIL</label>
            <input id="txtEmailReset" name="txtEmailReset" class="form-control" type="text" placeholder="Ingrese su correo electrónico">
          </div>
          <div class="form-group btn-container">
