...
<hr>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			<a href="<?= base_url() ?>" class="stext-110 cl8 hov-cl1 trans-04">
				Inicio
...
<div class="container p-b-100 p-t-100">
	<p class="stext-115 text-center">No hay rifas en el carrito <a href="<?= base_url() ?>/tienda" class="stext-301"> Ver rifas</a></p>
</div>
