		...
		<div class="col-md-12">
			<div class="tile">
				...
				<?php } else{
					...
					//La siguiente validacio se realiza porque la api de paypal no esta devolviendo (Solo a veces) el # de telefono
				...
				<section id="sPedido" class="invoice">
					...
					<div class="row invoice-info">
						...
						<div class="col-4">
								<address><strong>Nombre: </strong><?= $nombreCliente ?><br>
								<address><strong>Teléfono: </strong><?= $telCliente ?><br>					
								<address><strong>Dirección: </strong><?= $direccion1 ?><br>
