<?php 
	...
	class ProductosModel extends Mysql{
		...
		public function insertProducto(string $nombre, string $fecha, string $descripcion, string $descripcion_corta, int $codigo, int $categoriaid, string $precio, int $stock, string $ruta, int $status){
			$this->strNombre = $nombre;
			$this->strFecha = $fecha;
			$this->strDescripcion = $descripcion;
			$this->strDescripcionCorta = $descripcion_corta;
		...
		public function updateProducto(int $idproducto, string $nombre, string $fecha, string $descripcion, string $descripcion_corta, int $codigo, int $categoriaid, string $precio, int $stock, string $ruta, int $status){
