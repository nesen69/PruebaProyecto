...
trait TCliente{
	...
	public function insertCliente(string $nombre, string $apellido, int $cedula, int $telefono, string $email, string $password, int $tipoid){
		$this->con = new Mysql();
		...
		$sql = "SELECT * FROM persona WHERE 
				email_user = '{$this->strEmail}' OR identificacion = $this->intCedula";
	...
	public function insertPedido(string $idtransaccionpaypal = NULL, string $datospaypal = NULL, int $personaid, float $monto, int $tipopagoid, string $status){
		$this->con = new Mysql();
		$query_insert = "INSERT INTO pedido(idtransaccionpaypal,datospaypal,personaid,monto,tipopagoid,status) VALUES(?,?,?,?,?,?) ";
